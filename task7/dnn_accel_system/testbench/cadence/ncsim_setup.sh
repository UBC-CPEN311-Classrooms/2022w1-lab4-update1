...
mkdir -p ./libraries/word_copy_interface_1_avalon_master_limiter/
...
mkdir -p ./libraries/word_copy_interface_1_avalon_master_agent/
mkdir -p ./libraries/sdram_controller_s1_translator/
mkdir -p ./libraries/word_copy_interface_1_avalon_master_translator/
mkdir -p ./libraries/cpu/
mkdir -p ./libraries/rst_controller/
mkdir -p ./libraries/irq_mapper/
mkdir -p ./libraries/mm_interconnect_0/
mkdir -p ./libraries/word_copy_interface_1/
...
mkdir -p ./libraries/dotopt_accelerator_0/
mkdir -p ./libraries/dnn_accel_system/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_ociram_default_contents.dat ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_ociram_default_contents.hex ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_ociram_default_contents.mif ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_rf_ram_a.dat ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_rf_ram_a.hex ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_rf_ram_a.mif ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_rf_ram_b.dat ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_rf_ram_b.hex ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_rf_ram_b.mif ./
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_rsp_mux_003.sv"                           -work rsp_mux_003                                    -cdslib ./cds_libs/rsp_mux_003.cds.lib                                   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                                 -work rsp_mux_003                                    -cdslib ./cds_libs/rsp_mux_003.cds.lib                                   
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_cmd_mux_005.sv"                           -work cmd_mux_005                                    -cdslib ./cds_libs/cmd_mux_005.cds.lib                                   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                                 -work cmd_mux_005                                    -cdslib ./cds_libs/cmd_mux_005.cds.lib                                   
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                                            -work word_copy_interface_1_avalon_master_limiter    -cdslib ./cds_libs/word_copy_interface_1_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_reorder_memory.sv"                                             -work word_copy_interface_1_avalon_master_limiter    -cdslib ./cds_libs/word_copy_interface_1_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                                     -work word_copy_interface_1_avalon_master_limiter    -cdslib ./cds_libs/word_copy_interface_1_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                                            -work word_copy_interface_1_avalon_master_limiter    -cdslib ./cds_libs/word_copy_interface_1_avalon_master_limiter.cds.lib   
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_router_010.sv"                            -work router_010                                     -cdslib ./cds_libs/router_010.cds.lib                                    
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                                     -work sdram_controller_s1_agent_rsp_fifo             -cdslib ./cds_libs/sdram_controller_s1_agent_rsp_fifo.cds.lib            
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_slave_agent.sv"                                                -work sdram_controller_s1_agent                      -cdslib ./cds_libs/sdram_controller_s1_agent.cds.lib                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"                                         -work sdram_controller_s1_agent                      -cdslib ./cds_libs/sdram_controller_s1_agent.cds.lib                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_agent.sv"                                               -work word_copy_interface_1_avalon_master_agent      -cdslib ./cds_libs/word_copy_interface_1_avalon_master_agent.cds.lib     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_slave_translator.sv"                                           -work sdram_controller_s1_translator                 -cdslib ./cds_libs/sdram_controller_s1_translator.cds.lib                
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                                          -work word_copy_interface_1_avalon_master_translator -cdslib ./cds_libs/word_copy_interface_1_avalon_master_translator.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu.v"                                     -work cpu                                            -cdslib ./cds_libs/cpu.cds.lib                                           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_debug_slave_sysclk.v"                  -work cpu                                            -cdslib ./cds_libs/cpu.cds.lib                                           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_debug_slave_tck.v"                     -work cpu                                            -cdslib ./cds_libs/cpu.cds.lib                                           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_debug_slave_wrapper.v"                 -work cpu                                            -cdslib ./cds_libs/cpu.cds.lib                                           
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system_cpu_test_bench.v"                          -work cpu                                            -cdslib ./cds_libs/cpu.cds.lib                                           
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/wordcopy.sv"                                                                 -work word_copy_interface_1                          -cdslib ./cds_libs/word_copy_interface_1.cds.lib                         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dotopt.sv"                                                                   -work dotopt_accelerator_0                           -cdslib ./cds_libs/dotopt_accelerator_0.cds.lib                          
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_dnn_accel_system.v"                                         -work dnn_accel_system                               -cdslib ./cds_libs/dnn_accel_system.cds.lib                              
