...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire   [27:0] dnn_accel_system_data_master_translator_avalon_universal_master_0_address;              // dnn_accel_system_data_master_translator:uav_address -> dnn_accel_system_data_master_agent:av_address
	...
	wire          rsp_mux_src_valid;                                                                      // rsp_mux:src_valid -> dnn_accel_system_data_master_agent:rp_valid
	wire  [103:0] rsp_mux_src_data;                                                                       // rsp_mux:src_data -> dnn_accel_system_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                      // dnn_accel_system_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                                    // rsp_mux:src_channel -> dnn_accel_system_data_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                              // rsp_mux:src_startofpacket -> dnn_accel_system_data_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                // rsp_mux:src_endofpacket -> dnn_accel_system_data_master_agent:rp_endofpacket
	...
	wire   [27:0] dnn_accel_system_instruction_master_translator_avalon_universal_master_0_address;       // dnn_accel_system_instruction_master_translator:uav_address -> dnn_accel_system_instruction_master_agent:av_address
	...
	wire          rsp_mux_001_src_valid;                                                                  // rsp_mux_001:src_valid -> dnn_accel_system_instruction_master_agent:rp_valid
	wire  [103:0] rsp_mux_001_src_data;                                                                   // rsp_mux_001:src_data -> dnn_accel_system_instruction_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                                  // dnn_accel_system_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [5:0] rsp_mux_001_src_channel;                                                                // rsp_mux_001:src_channel -> dnn_accel_system_instruction_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                          // rsp_mux_001:src_startofpacket -> dnn_accel_system_instruction_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                            // rsp_mux_001:src_endofpacket -> dnn_accel_system_instruction_master_agent:rp_endofpacket
	...
	wire   [27:0] dnn_accel_system_debug_mem_slave_agent_m0_address;                                      // dnn_accel_system_debug_mem_slave_agent:m0_address -> dnn_accel_system_debug_mem_slave_translator:uav_address
	...
	wire  [104:0] dnn_accel_system_debug_mem_slave_agent_rf_source_data;                                  // dnn_accel_system_debug_mem_slave_agent:rf_source_data -> dnn_accel_system_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] dnn_accel_system_debug_mem_slave_agent_rsp_fifo_out_data;                               // dnn_accel_system_debug_mem_slave_agent_rsp_fifo:out_data -> dnn_accel_system_debug_mem_slave_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_002_src_data;                                                                   // cmd_mux_002:src_data -> dnn_accel_system_debug_mem_slave_agent:cp_data
	...
	wire  [103:0] cmd_mux_005_src_data;                                                                   // cmd_mux_005:src_data -> pio_0_s1_agent:cp_data
	...
	wire          dnn_accel_system_data_master_agent_cp_valid;                                            // dnn_accel_system_data_master_agent:cp_valid -> router:sink_valid
	wire  [103:0] dnn_accel_system_data_master_agent_cp_data;                                             // dnn_accel_system_data_master_agent:cp_data -> router:sink_data
	wire          dnn_accel_system_data_master_agent_cp_ready;                                            // router:sink_ready -> dnn_accel_system_data_master_agent:cp_ready
	wire          dnn_accel_system_data_master_agent_cp_startofpacket;                                    // dnn_accel_system_data_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dnn_accel_system_data_master_agent_cp_endofpacket;                                      // dnn_accel_system_data_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          dnn_accel_system_instruction_master_agent_cp_valid;                                     // dnn_accel_system_instruction_master_agent:cp_valid -> router_001:sink_valid
	wire  [103:0] dnn_accel_system_instruction_master_agent_cp_data;                                      // dnn_accel_system_instruction_master_agent:cp_data -> router_001:sink_data
	wire          dnn_accel_system_instruction_master_agent_cp_ready;                                     // router_001:sink_ready -> dnn_accel_system_instruction_master_agent:cp_ready
	wire          dnn_accel_system_instruction_master_agent_cp_startofpacket;                             // dnn_accel_system_instruction_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          dnn_accel_system_instruction_master_agent_cp_endofpacket;                               // dnn_accel_system_instruction_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire          dnn_accel_system_debug_mem_slave_agent_rp_valid;                                        // dnn_accel_system_debug_mem_slave_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] dnn_accel_system_debug_mem_slave_agent_rp_data;                                         // dnn_accel_system_debug_mem_slave_agent:rp_data -> router_004:sink_data
	wire          dnn_accel_system_debug_mem_slave_agent_rp_ready;                                        // router_004:sink_ready -> dnn_accel_system_debug_mem_slave_agent:rp_ready
	wire          dnn_accel_system_debug_mem_slave_agent_rp_startofpacket;                                // dnn_accel_system_debug_mem_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          dnn_accel_system_debug_mem_slave_agent_rp_endofpacket;                                  // dnn_accel_system_debug_mem_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [103:0] pio_0_s1_agent_rp_data;                                                                 // pio_0_s1_agent:rp_data -> router_007:sink_data
