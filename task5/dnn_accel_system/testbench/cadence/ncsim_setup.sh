...
mkdir -p ./libraries/word_copy_interface_0_avalon_master_agent/
mkdir -p ./libraries/sdram_controller_s1_translator/
mkdir -p ./libraries/word_copy_interface_0_avalon_master_translator/
mkdir -p ./libraries/cpu/
mkdir -p ./libraries/rst_controller/
mkdir -p ./libraries/irq_mapper/
mkdir -p ./libraries/mm_interconnect_0/
mkdir -p ./libraries/word_copy_interface_0/
mkdir -p ./libraries/vga_avalon/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_agent.sv"                                               -work word_copy_interface_0_avalon_master_agent      -cdslib ./cds_libs/word_copy_interface_0_avalon_master_agent.cds.lib     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                                          -work word_copy_interface_0_avalon_master_translator -cdslib ./cds_libs/word_copy_interface_0_avalon_master_translator.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/wordcopy.sv"                                                                 -work word_copy_interface_0                          -cdslib ./cds_libs/word_copy_interface_0.cds.lib                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_avalon.sv"                                                               -work vga_avalon                                     -cdslib ./cds_libs/vga_avalon.cds.lib                                    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_adapter.sv"                                                              -work vga_avalon                                     -cdslib ./cds_libs/vga_avalon.cds.lib                                    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_address_translator.sv"                                                   -work vga_avalon                                     -cdslib ./cds_libs/vga_avalon.cds.lib                                    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_controller.sv"                                                           -work vga_avalon                                     -cdslib ./cds_libs/vga_avalon.cds.lib                                    
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_pll.sv"                                                                  -work vga_avalon                                     -cdslib ./cds_libs/vga_avalon.cds.lib                                    
