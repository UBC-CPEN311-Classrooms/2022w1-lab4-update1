...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire    [4:0] rsp_mux_src_channel;                                                                    // rsp_mux:src_channel -> dnn_accel_system_data_master_agent:rp_channel
	...
	wire    [4:0] rsp_mux_001_src_channel;                                                                // rsp_mux_001:src_channel -> dnn_accel_system_instruction_master_agent:rp_channel
	...
	wire          cmd_mux_001_src_valid;                                                                  // cmd_mux_001:src_valid -> dnn_accel_system_debug_mem_slave_agent:cp_valid
	wire  [103:0] cmd_mux_001_src_data;                                                                   // cmd_mux_001:src_data -> dnn_accel_system_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                                  // dnn_accel_system_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                                // cmd_mux_001:src_channel -> dnn_accel_system_debug_mem_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                          // cmd_mux_001:src_startofpacket -> dnn_accel_system_debug_mem_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                            // cmd_mux_001:src_endofpacket -> dnn_accel_system_debug_mem_slave_agent:cp_endofpacket
	...
	wire          dnn_accel_system_debug_mem_slave_agent_rp_valid;                                        // dnn_accel_system_debug_mem_slave_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] dnn_accel_system_debug_mem_slave_agent_rp_data;                                         // dnn_accel_system_debug_mem_slave_agent:rp_data -> router_003:sink_data
	wire          dnn_accel_system_debug_mem_slave_agent_rp_ready;                                        // router_003:sink_ready -> dnn_accel_system_debug_mem_slave_agent:rp_ready
	wire          dnn_accel_system_debug_mem_slave_agent_rp_startofpacket;                                // dnn_accel_system_debug_mem_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          dnn_accel_system_debug_mem_slave_agent_rp_endofpacket;                                  // dnn_accel_system_debug_mem_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire    [4:0] router_005_src_channel;                                                                 // router_005:src_channel -> sdram_controller_s1_rsp_width_adapter:in_channel
	...
	wire    [4:0] sdram_controller_s1_rsp_width_adapter_src_channel;                                      // sdram_controller_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	...
	wire    [4:0] cmd_mux_003_src_channel;                                                                // cmd_mux_003:src_channel -> sdram_controller_s1_cmd_width_adapter:in_channel
	...
	wire          dnn_accel_system_debug_mem_slave_agent_rdata_fifo_src_valid;                            // dnn_accel_system_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] dnn_accel_system_debug_mem_slave_agent_rdata_fifo_src_data;                             // dnn_accel_system_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          dnn_accel_system_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> dnn_accel_system_debug_mem_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                      // avalon_st_adapter_001:out_0_valid -> dnn_accel_system_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                       // avalon_st_adapter_001:out_0_data -> dnn_accel_system_debug_mem_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                      // dnn_accel_system_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                      // avalon_st_adapter_001:out_0_error -> dnn_accel_system_debug_mem_slave_agent:rdata_fifo_sink_error
